...
function createFighter(fighter, selectFighter) {
    ...
    const onClick = event => selectFighter(event, fighter._id); // Works when you press the choice of a fighter
...
export default function createFighters(fighters) { // He receives an array of fighters works once at the beginning
    ...
    return container; // Весь контейнер сцені вибору з усіма Div
}
